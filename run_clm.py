...
def main():
    ...
    #CMD
    model_args, data_args, training_args = parser.parse_args_into_dataclasses("--model_name_or_path gpt2 \
...
--per_device_eval_batch_size 4".split(" "))
    # ##To view all
    # model_args, data_args, training_args = parser.parse_args_into_dataclasses(["--help"])
    ...
    # CUSTOM MODEL
    from custom_gpt2_001 import GPT2LMHeadModel
    CUSTOM_MODEL = GPT2LMHeadModel
    if CUSTOM_MODEL is None:
        ModelClass = AutoModelForCausalLM
    else:
        ModelClass = CUSTOM_MODEL
